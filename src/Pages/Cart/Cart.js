...
const Cart = () => {
    ...
    const handleRemoveItem = (index) => {
        ...
        handleShowToast(true, 'error','Product is removed');
    };
            ...
            <div className="bg-white p-3 cart-footer">
                <div className="row">
                    ...
                    <div className="col-lg-8 d-flex justify-content-end">
                        <CustomButton variant={"contained"} color={"success"} onClick={()=>console.log("cancel")}> Cancel</CustomButton>
                        <CustomButton variant={"contained"} color={"error"} onClick={handlePlaceOrder}>Place order</CustomButton>
                    </div>
                </div>
            </div>
            {showToast && (
